...
const { placeOrder, getMyOrders, getOrderById, cancelOrder, getSellerOrders, getAllOrders, updateOrderStatus, placeSingleOrder } = require('../controllers/order');
...
router.post("/place-order" ,authUser,placeSingleOrder);
